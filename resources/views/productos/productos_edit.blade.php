		...
		<div class="row">
				<div class="col-12">
						...
						<form method="POST" action="{{route("productos.update", [$producto])}}"  enctype="multipart/form-data">
								...
								<input  autocomplete="off" name="precio_en_dolar" class="form-control"
										 type="decimal(9,2)" placeholder="Precio en dolar" value="{{$producto->precio_en_dolar}}">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="label" for="foto">Foto nueva</label>
